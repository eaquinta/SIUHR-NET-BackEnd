...
namespace Apphr.WebUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)  // POST
        {            
        ...
        [AllowAnonymous]
        public async Task<ActionResult> ConfirmEmail(int userId, string code) // GET
        {
        ...
        public ActionResult LogOff() // POST
        {
