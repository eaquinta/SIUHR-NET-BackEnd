...
$(function () {
    ...
    child.initForm = function () {
        $('#MaterialNombre, #MaterialPrecio, #UnidadMedida').attr('readonly', 'readonly').attr('tabindex','-1');        
    ...
    $('#DepartamentoCodigo').on('change', function () {
        $.ajax({
            type: "GET",
    ...
    $('#MaterialCodigo').on('change', function () {
        ...
        //$.ajax({
        //    type: "GET",
        //    url: '@Url.Action("GetMaterialById", "Materiales")',//  this for calling the web method function in controller.
        //    data: { id: $("#MaterialId").val() }, // user name value
        //    contentType: "application/json; charset=utf-8",
        //    dataType: "json",
        //    success: function (response) {
        //        if (response.result) {
